...
import com.patterns.creational.builder.LuxaryHouse;
...
public class LuxaryHouseBuilder implements Builder {
	...
	public LuxaryHouse getResult() {
		return new LuxaryHouse(type, room, pool, window, garage, roof);
	}
